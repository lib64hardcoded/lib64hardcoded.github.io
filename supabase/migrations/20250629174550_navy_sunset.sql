/*
  # Fix bug reports schema and RLS policies

  1. Changes
    - Fix column names in bug_reports table (expected_behavior, actual_behavior)
    - Update RLS policies for users table to allow guest user creation
